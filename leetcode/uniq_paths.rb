...
def path_finder(row, col, memo = {})
  ...
  row_above_count = memo[[row - 1, col]] || path_finder(row - 1, col, memo)
  col_left_count  = memo[[row, col - 1]] || path_finder(row, col - 1, memo)

  memo[[row, col]] = row_above_count + col_left_count
